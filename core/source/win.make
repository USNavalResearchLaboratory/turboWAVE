...
TW_Compiler = cl
TW_Linker = cl
RELEASE_FLAGS = /EHsc /c /O2 /DUSE_DESKTOP /DNDEBUG /DVBITS=$(VBITS)
PROFILE_FLAGS = /EHsc /c /O2 /Zi /DUSE_DESKTOP /DVBITS=$(VBITS)
DEBUG_FLAGS = /EHsc /c /Od /Zi /DUSE_DESKTOP /DVBITS=$(VBITS)
LIB_PATH =
LIBS =
!ENDIF
...
TW_Compiler = icl
TW_Linker = icl
RELEASE_FLAGS = /EHsc /c /O2 /Qopenmp /QxHOST /DUSE_DESKTOP /DUSE_OPENMP /DNDEBUG /DVBITS=$(VBITS)
PROFILE_FLAGS = /EHsc /c /O2 /Qopenmp /QxHOST /Zi /DUSE_DESKTOP /DUSE_OPENMP /DVBITS=$(VBITS)
DEBUG_FLAGS = /EHsc /c /Od /Qopenmp /Zi /DUSE_DESKTOP /DUSE_OPENMP /DVBITS=$(VBITS)
LIB_PATH =
LIBS =
!ENDIF
...
Units.obj: Units.cpp $(BASE_HEADERS)
