...
The build tools needed for TW 5.x are still too unstable to provide an easy install at this time.
Your best bet is to look at the comments inside CMakeLists.txt.
